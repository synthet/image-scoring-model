...
Compiled procedural skills use thin bootloaders pointing at `scripts/agent_skills/*.py`. Nothing is
compiled in this repo yet — see [`.agent/SKILL_COMPILATION.md`](../../../.agent/SKILL_COMPILATION.md)
and [`/compile-skill`](../../commands/compile-skill.md).
