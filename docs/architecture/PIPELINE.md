...
title: Pipeline
description: End-to-end eye-quality flow, keypoint schema, and scoring heuristics.
resource: architecture/PIPELINE.md
tags: [docs, architecture, scoring]
...
**Failure types** are confidence-gated: low-confidence detections yield `failure_type: none` rather than a hard reject. See [API_CONTRACT.md](../technical/API_CONTRACT.md) for the full enum list.
